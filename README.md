...
- `[WorkerTransfer]` is equivalent to `[WorkerTransfer(WorkerTransferMode.TransferAll, Depth = 3)]` which indicates that all Transferable objects that require transfer should be added to the transfer list. 
